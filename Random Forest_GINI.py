...
if __name__ == "__main__":
	...
	sklearn_results = []
	print(" ")
	print("Building Random Forest using Native code with " +str(num_of_trees) + " trees...")
	native_results.append(run_random_forest(num_of_trees,num_of_features))
	print(" ")
	print("Building Random Forest using Sklearn package with " +str(num_of_trees) + " trees...")
